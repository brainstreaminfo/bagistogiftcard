            ...
            app.component('v-gift-card-card', {
                ...
                methods: {
                    ...
                    loadPayPalScript() {
                        ...
                        script.src = "https://www.paypal.com/sdk/js?client-id={{clientid}}&currency=USD"; // In place of {{clientid}} add the production client id for production mode. For testing add the sandbox clientid if you want to see the giftcard process in sandbox environment.
                        script.onload = () => {
                            this.$nextTick(() => {
